...
import { InputConfig, InputPreview, NodeContainer, MenuInput, MenuButton, CustomToolbar, CloseButton } from "./link.style";
...
export function Link({ data, id, groupID }) {
  ...
  const [placeholder, setPlaceholder] = useState(data.placeholder || "https://exemplo.com");
