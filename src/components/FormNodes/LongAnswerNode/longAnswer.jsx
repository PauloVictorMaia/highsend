...
import { InputConfig, InputPreview, NodeContainer, MenuInput, MenuButton, CustomToolbar, CloseButton } from "./longAnswer.style";
...
export function LongAnswer({ data, id, groupID }) {
  ...
  const [placeholder, setPlaceholder] = useState(data.placeholder || "Resposta longa...");
