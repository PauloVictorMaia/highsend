...
import { InputConfig, InputPreview, NodeContainer, MenuInput, MenuButton, CustomToolbar, CloseButton } from "./shortAnswer.style";
...
export function ShortAnswer({ data, id, groupID }) {
  ...
  const [placeholder, setPlaceholder] = useState(data.placeholder || "Resposta curta...");
