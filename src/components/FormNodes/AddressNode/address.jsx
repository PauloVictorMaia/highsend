...
import { InputConfig, InputPreview, NodeContainer, MenuInput, MenuButton, CustomToolbar, CloseButton } from "./address.style";
...
export function Address({ data, id, groupID }) {
