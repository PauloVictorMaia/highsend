...
import { InputConfig, InputPreview, NodeContainer, MenuInput, MenuButton, CustomToolbar, CloseButton } from "./number.style";
...
export function Number({ data, id, groupID }) {
  ...
  const [placeholder, setPlaceholder] = useState(data.placeholder || "Um número...");
